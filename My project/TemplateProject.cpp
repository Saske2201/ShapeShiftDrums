...
#define ENABLE_KB_OVERLAY 0
            ...
            // ========================================================================================================== CRASH R ROOM KNOB ==========================================================================================================
            const IRECT CrashRRoomKnob = IRECT::MakeXYWH(890.f, 232.6f, 65.f, 65.f);
            ...
            // ========================================================================================================== CHINA ROOM KNOB ==========================================================================================================
            const IRECT ChinaRoomKnob = IRECT::MakeXYWH(1270.5f, 232.6f, 65.f, 65.f); // подвинь при необходимости
            auto* pChinaRoomKnob = pGraphics->AttachControl(new CBodyPointerKnob(ChinaRoomKnob, body, pointer, kParamChinaRoom, -150.0, +150.0));
            // ========================================================================================================== SPLASH ROOM KNOB ==========================================================================================================
            const IRECT SplashRoomKnob = IRECT::MakeXYWH(1016.3f, 232.6f, 65.f, 65.f); // между CrashR и China
            ...
            // ========================================================================================================== RIDE ROOM KNOB ==========================================================================================================
            const IRECT RideRoomKnob = IRECT::MakeXYWH(1144.3f, 232.6f, 65.f, 65.f);
            auto* pRideRoomKnob = pGraphics->AttachControl(
                new CBodyPointerKnob(RideRoomKnob, body, pointer, kParamRideRoom, -150.0, +150.0));
            // ========================================================================================================== HH ROOM KNOB ==========================================================================================================
            const IRECT HHRoomKnob = IRECT::MakeXYWH(633.5f, 232.6f, 65.f, 65.f); // слева от Crash L

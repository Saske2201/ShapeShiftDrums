...
// РАЗМЕРЫ: как у master (тот же handleScale и masterHandleBmp)
            ...
            const IRECT transientKnobR = IRECT::MakeXYWH(1103.0f, 630.5f, 81.f, 81.f);

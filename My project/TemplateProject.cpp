...
// РАЗМЕРЫ: как у master (тот же handleScale и masterHandleBmp)
            ...
            const IRECT transientKnobR = IRECT::MakeXYWH(1101.5f, 631.5f, 81.f, 81.f);
